          ...
          <div class="container">
              <div class="banner_content text-center">
                  <div class="page_link">
                      ...
                      <router-link to="/thanks"><a>Thanks</a></router-link>
                  </div>
              </div>
          </div>
      </div>
  ...
  <!--================ End Banner Area =================-->
			...
			<div class="row justify-content-start align-items-center">
				<div class="col-lg-12">
					<div class="main_title text-left">
						<p class="top_text">My Thanks <span></span></p>
    ...
    <div class="tab-group rates-page-tabs">
        ...
        <ul class="nav nav-tabs responsive" role="tablist">
            <li role="presentation"><a href="#loan-rates" aria-controls="loan-rates" role="tab" data-toggle="tab">Lecturers</a></li>
            <li role="presentation"><a href="#mortgage-rates" aria-controls="mortgage-rates" role="tab" data-toggle="tab">Companies</a></li>
            <li role="presentation"><a href="#checking-savings-rates" aria-controls="checking-savings-rates" role="tab" data-toggle="tab">Sponsors</a></li>
        </ul>

        <!-- Tab panes -->
        <div class="tab-content responsive">
            <div role="tabpanel" class="tab-pane active" id="loan-rates">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                    National Diploma in Information Technology & Communication (NVQ 5)
                                </a>
                            </h4>
                        </div><!--/.panel-heading -->
            ...
            <div role="tabpanel" class="tab-pane" id="mortgage-rates">
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
