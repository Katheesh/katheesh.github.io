    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          ...
          <a class="navbar-brand logo_h"><router-link to="/"><img src="img/logo.png" alt=""></router-link> </a>
          <a class="navbar-brand logo_inner_page"><router-link to="/"><img src="img/logo2.png" alt=""></router-link></a>      
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav">
              ...
              <li class="nav-item"><router-link to="/blogs"><a class="nav-link">Blogs</a></router-link></li>
              <li class="nav-item"><router-link to="/quotes "><a class="nav-link">Quotes</a></router-link></li>
